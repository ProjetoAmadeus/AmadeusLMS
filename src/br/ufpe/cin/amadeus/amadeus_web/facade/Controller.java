...
public class Controller {
	...
	public void confirmRegistry(AccessInfo accinfo) {
 		String subject = "Confirmaï¿½ï¿½o de cadastro na Plataforma de Educaï¿½ï¿½o a Distï¿½ncia Amadeus";
 		String message = "Parabï¿½ns "+ accinfo.getPerson().getName() +",\n";
 		message += "Seu cadastro na plataforma de de Educaï¿½ï¿½o  a distï¿½ncia Amadeus foi realizado com sucesso. \n";
	...
	public String searchString(String oldString){
		...
		for(int i = 0; i< length; i = i + 1){
		  ...
		  if ( c.equals("a") || c.equals("e") || c.equals("i") || c.equals("o") 
			  ...
			  if(i == length - 1 && length > 1){ // quando é o último char
				  
				  newString = newString.substring(0, i) + "%";
				  
			  } else if (i == 0 && length > 1) { // quando é o primeiro
				  newString = "%" +  
