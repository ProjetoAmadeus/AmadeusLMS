...
<<<<<<< HEAD
	...
	public static int LOG_CODIGO_FORUM_TOPICO = 4; //Ok - visualizacoes de topicos
	public static int LOG_CODIGO_VISUALIZACAO_MATERIAL = 5; //Ok - abertura de materias dos modulos
	public static int LOG_CODIGO_RESPOSTA_ENQUETE = 6; //Ok
	public static int LOG_CODIGO_ABRIR_JOGO = 7; //Ok
