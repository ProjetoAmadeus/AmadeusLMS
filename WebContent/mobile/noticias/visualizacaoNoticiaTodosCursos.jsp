...
<table style="width: 100%;">
	...
	<tr>
		...
		%> 		<a href="<%=request.getContextPath()%>/mobile/atividades/homeEnquete.jsp?idPoll=<%=n.getIdElement()%>&login=<%=login%>&idCourse=<%=id%>&tipo=noticiaTodos&idNotice=<%=idNoticia%>&pagina=<%=pagina%>">Clique
 ...
 %>
	...
	<tr>
		<td>
			<a href="<%=request.getContextPath()%>/mobile/noticias/noticiasTodosCursos.jsp?login=<%=login%>&pagina=<%=pagina%>">Voltar</a>
