...
<%
	...
	HomeworkMobile h = facMobile.getHomework(Integer.parseInt(idAtividade), tipo);
%>
<table style="width: 100%;">
	...
	<tr>
		<td style="border-bottom: 1px solid #cccccc;"><strong><%=h.getName()%></strong>
		</td>
	</tr>
	<tr>
	...
	<tr>
		<td>
			<a href="<%=request.getContextPath()%>/mobile/atividades/homeAtividadesModulo.jsp?login=<%=login%>&idCourse=<%=id%>&idModule=<%=idModule%>&pagina=<%=pagina%>">Voltar</a>
