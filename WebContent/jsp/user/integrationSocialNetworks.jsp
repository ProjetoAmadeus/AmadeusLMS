	...
	<div id="pBody" class="pBody">
		...
		<div id="pBreadCrumbs" class="pBreadCrumbs">
			<ul id="breadcrumb">
				...
				<li><bean:message key="integrationSocialNetworks.heading"/></li>
			</ul>
		</div>
		<div id="pLeftMenu" class="pLeftMenu">
			<div id="side_menu_1">
				<ul id="menu_sessoes">
					...
					<li><img src="themes/default/imgs/menu/user-password-16x16.png" border="0" title="Trocar Senha" />&nbsp;<bean:message key="editPassword.heading"/></li>
			    	...
			    	<li>
	         			<html:link action="user.do?method=showViewIntegrationSocialNetworks">
	         				<img src="themes/default/imgs/menu/users-16x16.png" border="0" title="Social Accounts"/>&nbsp;<b><bean:message key="sideMenu.integrationSocialNetworks"/></b>
		        		</html:link>
		        	</li>
				</ul>
			</div>
		...
		<div id="pContent" class="pContent">
			<html:errors property="twitterLogin" />
			<html:errors property="facebookLogin" />
			...
			<table border="0" cellpadding="0" cellspacing="0" style="width: 100%;">
				...
				<tr>
					<td></td><td class="formDescription">Ex: amadeuslms</td>
				</tr>
				<br /><br />
				
				<tr>
					<td class="formAttribute"><img src="themes/default/imgs/facebook.png" style="padding-right: 9px;" border="0" height="32px" width="32px" title="Social Accounts"/><bean:message key="integrationSocialNetworks.facebookLogin"/>:</td>
					<td>
						<html:text name="socialProfiles" property="facebookLogin" style="width: 100%;" />
					</td>
				</tr>
				<tr>
					<td></td><td class="formDescription">Ex: amadeuslms</td>
				...
				<tr>
					<td></td><td align="right"><html:submit property="integrationSocialNetworks" styleClass="button"><bean:message key="integrationSocialNetworks.integrate"/></html:submit></td>
				</tr>
			</table>
			</html:form>
	  	</div>			
