	...
	<div id="pBody" class="pBody">
		...
		<div id="pBreadCrumbs" class="pBreadCrumbs">
			<ul id="breadcrumb">
				...
				<li><bean:message key="managerUsers.menu.userAccount"/></li>
			</ul>
		</div>
		<div id="pLeftMenu" class="pLeftMenu">
			<div id="side_menu_1">
				<ul id="menu_sessoes">
					...
					<li><b><img src="themes/default/imgs/menu/user-16x16.png" title="<bean:message key="managerUsers.menu.userAccount"/>" />&nbsp;<bean:message key="managerUsers.menu.userAccount"/></b></li>
		...
		<div id="pContent" class="pContent">
			<html:errors />
			<html:form action="/userNewForm" focus="name" enctype="multipart/form-data">
			...
			<table border="0" cellpadding="0" cellspacing="0">
				...
				<tr>
					<td class="formAttribute"><bean:message key="managerUsers.profileType"/></td>
					<td>
						<html:select property="userType">
							<html:option value=""><bean:message key="managerUsers.profileType.type"/></html:option>
							<html:option value="ADMIN"><bean:message key="managerUsers.profileType.admin"/></html:option>
							<html:option value="STUDENT"><bean:message key="managerUsers.profileType.student"/></html:option>
							<html:option value="PROFESSOR"><bean:message key="managerUsers.profileType.professor"/></html:option>
						</html:select>
					</td>
				</tr>
				<tr>
				...
				<tr>
					...
					<td><html:text property="login" />&nbsp;<img src="themes/default/imgs/menu/refresh-16x16.png" style="cursor: pointer;" title="Verificar se o login está disponível." /></td>
				</tr>
				<tr>
					<td></td><td class="formDescription"><bean:message key="userRegistrationForm.loginDescription"/></td>
				</tr>
				...
				<tr>
					...
					<td><html:text property="email" style="width: 85%;" />&nbsp;<img src="themes/default/imgs/menu/refresh-16x16.png" style="cursor: pointer;" title="Verificar se o e-mail está disponível." onclick="verifyEmail(0, document.userNewForm.email.value);" />
				...
				<tr>
					...
					<td><html:text property="cpf" styleId="cpf" style="width: 100px;" /></td>
				</tr>
				<tr>
				...
				<tr>
					...
					<td><html:text property="phoneNumber" styleId="phoneNumber" style="width: 95px;" /> </td>
				</tr>
				<tr>
				...
				<tr>
					...
					<td>
						<html:radio property="gender" value="M"></html:radio>
						<bean:message key="editUserForm.gender.male" />
						<html:radio property="gender" value="F"></html:radio>
				...
				<tr>
					...
					<td><html:text styleId="birthDate" property="birthDate" styleClass="birthDate" style="width: 80px;" /></td>
				</tr>
				<tr>
				...
				<tr>
					...
					</html:select> - <html:text property="city" />
					</td>
				</tr>
				<tr>
				...
				<tr>
					<td class="formAttribute"><bean:message key="editUserForm.photo"/>:</td>
					<td><html:file property="image" /></td>
				</tr>
				<tr>
					<td></td><td class="formDescription"><bean:message key="editUserForm.photoDescription"/></td>
				</tr>
				...
				<tr>
					...
					<td><html:text property="instituition" style="width: 100%;" /></td>
				</tr>
				<tr>
				...
				<tr>
					...
					<td><html:textarea property="description" style="width: 100%;"></html:textarea></td>
				</tr>
				<tr>
