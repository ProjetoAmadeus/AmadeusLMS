...
<head>
	...
	<script type='text/javascript'>
		$(document).ready(function(){
			$('#social-mensagens').click(function(event){
				$.ajax({
					url: 'social.do?method=testMessageTool'
				});
			});
			
			$('#social-twitter').click(function(event){
				$.ajax({
					url: 'social.do?method=testTwitterTool'
				});
			});
...
<body>
	<div id="pBody" class="pBody">
		...
		<div id="pContent" class="pContent">
			<button id="social-mensagens">Social Mensagens</button>
			<button id="social-twitter">Social Twiter</button>
		</div>
		<!-- 
