...
<html:html>
	...
	<body>
		...
		<div id="pLeftMenu" class="pLeftMenu">
			...
			<div id="content">
				<dl class="insert2">
					<html:form action="/insertCourseStepOne" focus="name">
					<html:errors/>
					...
					<dt><bean:message key="courseForm.objectives"/></dt>
						<dd class="field"><html:textarea property="objectives" styleClass="formfield" styleId="courseObjectives"/></dd>
						<dd class="description"><bean:message key="courseForm.courseObjectives"/></dd>
					<dt><bean:message key="courseForm.content"/></dt>
						<dd class="field"><html:textarea property="content" styleClass="formfield" styleId="courseContent"/></dd>
						<dd class="description"><bean:message key="courseForm.courseContent"/></dd>
					<dt><bean:message key="courseForm.maxAmountStudents"/></dt> 
						<dd class="field"><html:text property="maxAmountStudents" styleClass="formfield" styleId="courseStudents"/></dd>
				...
				<dt><bean:message key="courseForm.initialRegistrationDate"/></dt> 
					...
					<dt class="field"><html:submit property="insertCourseStepOne" styleClass="button"><bean:message key="courseForm.nextStep"/></html:submit></dt>
