...
<script type="text/javascript">
	function lfNewExternalLinkActivity(idModule, positionModule) {
		newExternalLinkActivity(idModule, positionModule, '<img border=0 src=<%=request.getContextPath()%>/themes/default/imgs/ajax-loader-activity.gif /><bean:message key="ajaxLoading.save" />');
	}
</script>
...
<html:form action="newExternalLink" >
	...
	<div class="cmLine">
		<html:text property="nameExternalLink" />
	</div>
	<div class="cmLine">
		<label class="labelAttribute"><bean:message key="material.externalLink.url"/>:</label>
	</div>
	<div class="cmLine">	
		<html:text property="urlExternalLink" styleClass="cmTextUrl" />
	</div>
	<div class="cmLine">	
		<label class="labelAttribute"><bean:message key="material.externalLink.description"/>:</label>
	</div>
	<div class="cmLine">
		<html:text property="descriptionExternalLink" styleClass="cmTextArea" />
	</div>
	<div class="cmFooter">
		<div id="actions">
			<a onclick="lfNewExternalLinkActivity(${module.id}, ${module.position})" href="javascript:void(0)"><bean:message key="general.save" /></a> / 
